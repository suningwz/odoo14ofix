    ...
    def get_altas(self):
        ...
        for e in mov_altas:
            ...
            line = "{rpatronal:>11.11}{nss:>11.11}" \
                   ...
                   "{space:2.1}{tipo_mov:02.0f}{guia:>5.5}{clave_trab:>10.10}" \
                   "{space:1.1}{curp:>18.18}{idf:1}{folio_incapacidad:>8.8}{ndias:2.1}{sucursal:03.0f}" \
                   "\r\n".format(
                ...
                space=' ',
                tipo_trab=tipo_trab,
                #ipo_trab=float(tipo_trab,
                tipo_salario=tipo_salario,
                jornada=jornada,
                fecha=datetime.datetime.strptime(str(e.fecha_alta), '%Y-%m-%d').strftime("%m%d%Y"),
                umf=self.umf,
