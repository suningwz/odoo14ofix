...
class RegistroPatronal(models.Model):
    ...
    #=====Branch Details ==============#
    branch_ids = fields.Many2many('company.branch','rel_employee_reg_company_branch','reg_id','branch_id',string='Branch')
    
    branch_id = fields.Many2one('company.branch','Branch')
    code = fields.Char(related="branch_id.code")
    riesgo_puesto = fields.Many2one(related="branch_id.riesgo_puesto")
    registro_patronal = fields.Many2one(related="branch_id.registro_patronal")
    xs_id_region = fields.Selection(related="branch_id.xs_id_region")
