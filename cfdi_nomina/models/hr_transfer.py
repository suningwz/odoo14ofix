...
class HrEmployeeTransfer(models.Model):
    ...
    branch_id = fields.Many2one('company.branch',string='Origin Warehouse',readonly=True)
    branch_dest_id = fields.Many2one('company.branch',string='Destination Warehouse',readonly=True)